...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("wrong floor and room", "venue_access_issue"),
        ("地址不对，房间不对", "venue_access_issue"),
        ("Smart Manikin 黑屏怎么办", "smart_manikin_troubleshooting"),
        ("蓝牙连不上", "smart_manikin_troubleshooting"),
        ("ipad打不开", "smart_manikin_troubleshooting"),
        ("iPad won't turn on", "smart_manikin_troubleshooting"),
        ("PAD connected but TRAINING receives no data", "smart_manikin_troubleshooting"),
        ("完成照片怎么拍", "smart_manikin_troubleshooting"),
        ("找不到房间", "smart_manikin_troubleshooting"),
        ("source recorded fix does not work", "smart_manikin_troubleshooting"),
        ("修复无效", "smart_manikin_troubleshooting"),
        ("All Session Done support email", "smart_manikin_troubleshooting"),
        ("iPad connected but TRAINING receives no data", "smart_manikin_troubleshooting"),
        ...
        ("student not found on roster", "student_checkin_issue"),
        ("wrong location for check-in", "student_checkin_issue"),
        ...
        ("platform not loading", "internet_outage"),
        ("no network in the classroom", "internet_outage"),
        ("no electricity and lights out", "electricity_outage"),
        ("breaker issue", "electricity_outage"),
        ("现场有人受伤了", "safety_or_emergency"),
        ("the room is unsafe", "safety_or_emergency"),
        ("怎么写现场事件报告", "incident_report"),
        ("create incident summary", "incident_report"),
        ("write report", "incident_report"),
        ("什么时候要升级给主管", "escalation_guidance"),
        ("reschedule approval", "escalation_guidance"),
        ("是否继续上课", "escalation_guidance"),
