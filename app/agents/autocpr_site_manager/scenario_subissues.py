...
# Code / passcode request markers (access "passcode" path). Includes casual
# locked-out phrasing so a vague access question still lands on the passcode panel
# (which shows redacted availability when locked, real codes only when unlocked).
